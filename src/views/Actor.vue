<template>
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none" v-if="actor.social">
                <img
                ...
                <ul class="flex items-center mt-4">
                    <li v-if="actor.social.facebook_id">
                        <a
                            :href="
                                'https://facebook.com/' +
                                actor.social.facebook_id
                            "
                            title="Facebook"
                        >
                            <svg
                    ...
                    <li class="ml-6" v-if="actor.social.instagram_id">
                        <a
                            :href="
                                'https://instagram.com/' +
                                actor.social.instagram_id
                            "
                            title="Instagram"
                        >
                            <svg
                    ...
                    <li class="ml-6" v-if="actor.social.twitter_id">
                        <a
                            :href="
                                'https://twitter.com/' + actor.social.twitter_id
                            "
                            title="Twitter"
                        >
                            <svg
                    ...
                    <li class="ml-6" v-if="actor.homepage">
                    ...
                    >
                        <router-link
                            :to="{
                                name: 'Details',
                                params: {
                                    type: fvt.title ? 'movies' : 'tvs',
                                    id: fvt.id,
                                },
                            }"
                            ><img
                                :src="shortImage(fvt.poster_path)"
                                alt="poster"
                                class="
                                    hover:opacity-75
                                    transition
                    ...
                    <strong
                        ><router-link
                            :to="{
                                name: 'Details',
                                params: {
                                    type: credit.title ? 'movies' : 'tvs',
                                    id: credit.id,
                                },
                            }"
                            class="hover:underline"
                            >{{ credit.title ?? credit.name }}</router-link
                        ></strong
                    >
                    as {{ credit.character }}
                </li>
